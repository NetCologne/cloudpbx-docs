...
* Gruppenname (2, nur Groß- und Kleinbuchstaben, Ziffern, Bindestrich, Unterstrich [siehe Hinweise](https://cloudpbx-doku.netcologne.de/docs/problemloesungen/verwendung-von-namen-f%C3%BCr-gruppen/)) und die <br>
