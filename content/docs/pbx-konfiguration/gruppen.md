...
* Gruppenname (2, nur Kleinbuchstaben, keine Leer- oder Sonderzeichen) [Verwendung von Namen für Gruppen](https://cloudpbx-doku.netcologne.de/docs/problemloesungen/verwendung-von-namen-f%C3%BCr-gruppen) und die <br>
