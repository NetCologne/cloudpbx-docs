...
Sie befinden sich nun in der Administrator-Maske der CloudPBX. Das Dashboard liefert eine Überischt zu Nachrichten (Messages), Anrufen (Calls), den registrierten Endgeräten und der PBX-Konfiguration:
...
2. Gruppen <br>
Eine Sonderform der Nebenstelle ist eine Gruppennummer. Dabei werden ohne zusätzliche Kosten mehrere Nebenstellen zu einer solchen zusammengefasst. Hier können sie die Einstellungen für eine [Gruppennummer festlegen](https://cloudpbx-doku.netcologne.de/docs/konfiguration/gruppen/) <br>
